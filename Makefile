...
docker-archive: docker-images
	docker save organizationmgr:v0.1.5 agentmgr:v0.1.3 agentpoolmgr:v0.1.3 credentialsmgr:v0.1.3 hashicorp/tfc-agent:1.0.2 containers.cisco.com/cn-ecosystem/tf-nd-app-ui:v0.1.5  | gzip > images.tar.gz
