...
docker-images: bundle services
	docker build --file deployment/docker/organizationmgr/Dockerfile --tag organizationmgr:v0.1.3 .
...
docker-archive: docker-images
	docker save organizationmgr:v0.1.3 agentmgr:v0.1.3 agentpoolmgr:v0.1.3 credentialsmgr:v0.1.3 hashicorp/tfc-agent:1.0.2 containers.cisco.com/cn-ecosystem/tf-nd-app-ui:v0.1.4  | gzip > images.tar.gz
